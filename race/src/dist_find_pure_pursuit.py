...
waypoints = [
	...
	(2.22, 5, s_ld, s_an), (1.27, 5.2, s_ld, s_an), (0.32, 5, s_ld, s_an), (-.78, 4.56, s_ld, s_an), (-1.45, 3.67, s_ld, s_an), (-1.74, 2.68, s_ld, 0.8), (-1.63, 1.87, s_ld, 0.8), (-1.19, 1.15, s_ld, 0.8),
	(-.7, .63, s_ld, 0.8)]
'''
...
def goal_point():
	global lookahead_dist, steering_angle_constant
	"""
